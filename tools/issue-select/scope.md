...
I'm comfortable with Python for scripting and backend logic, and have
some experience with JavaScript/TypeScript on the frontend. I'm open to
a wide range of first issues, including documentation fixes and test
coverage gaps, since those are a low-risk way to learn a new codebase's
conventions before touching core logic. I'd like to avoid issues that
need deep familiarity with a large, unfamiliar framework or build
system just to get started.
